...
extern "C" {
	...
	void DB_ENGINE_LIBRARY_EXPORT addCustomer(char* customer_firstName, char* customer_lastName, char* customer_address, char* customer_zip, char* customer_city, int* customer_id);

	void DB_ENGINE_LIBRARY_EXPORT queryInvoicesByCustomer(int customer_id);

	void DB_ENGINE_LIBRARY_EXPORT addInvoiceLine(int invoice_id,
		char* invoiceline_product,
		int invoiceline_quantity,
		double invoiceline_price);

	void DB_ENGINE_LIBRARY_EXPORT addInvoice(int customer_id,
